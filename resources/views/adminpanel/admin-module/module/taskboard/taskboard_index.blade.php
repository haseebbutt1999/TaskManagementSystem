...
{{--                                        @if($project->tasks->where('status_id', $status->id)->pluck('title')->first() != null)--}}
        ...
        {{--                                                <span class="status-title"><a href="task-view.html">{{$project->tasks->where('status_id', $status->id)->pluck('title')}}</a></span>--}}
