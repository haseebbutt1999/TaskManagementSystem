...
{{--                                                </select>--}}
                                                    ...
                                                    <div id="accordion">
                                                        ...
                                                        <div class="card ">
                                                            <div class="card-header bg-white" id="headingTwo">
                                                                <h5 class="mb-0">
                                                                    <div class="btn bg- collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                                                        <input type="radio" class="payment-method"  name="payment-method" value="stripe" >
                                                                    ...
                                                                    <div class="panel-body">
                                                                        <div class='form-row row'>
                                                                            <div style="border: none;"
                                                                                ...
                                                                                <input required hidden value="stripe" name="payment_method"
                    ...
                    <form class="w3-container w3-display-middle w3-card-4 " method="POST" id="payment-form"  action="/payment/add-funds/paypal">
                        {{ csrf_field() }}
                        <input class="w3-input form-control w3-border total"  value="" hidden name="amount" type="text"></p>
