        ...
        <div class="container">
            ...
            <div class="account-box">
                <div class="account-wrapper">
                    ...
                    @endif
                    <!-- Account Form -->
                    <form class="js-validation-lock" method="POST" action="{{ route('password.email') }}">
                        @csrf
                        <div class="form-group">
                            <label>Email Address</label>
                            <input id="email" type="email" class="form-control-lg form-control-alt form-control @error('email') is-invalid @enderror" name="email"  value="{{ old('email') }}" required autocomplete="email" autofocus>
