        ...
        <div class="container">
            ...
            <div class="account-box">
                <div class="account-wrapper">
                    ...
                    <p class="account-subtitle">Please fill the following details to reset password.</p>
                    ...
                    <form class="js-validation-signup" method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="form-group">
                            <label>Email</label>
                            <input type="email" class="form-control @error('email') is-invalid @enderror form-control-lg form-control-alt" id="email" name="email" value="{{$email ?? old('email') }}" required autocomplete="email" placeholder="Email">
                            @error('email')
